...
\author {Mike Izbicki}
\institute{Claremont McKenna College}
\title[Highly Multiclass Classification]{}
\date{August 23, 2017}
...
%\input{slides/background-ml}
%\input{slides/background-ml2}
%\input{slides/motivation-not}
%\input{slides/results-summary}
%
%\input{slides/sgd-xentropy}
%\input{slides/keyidea.tex}
%\input{slides/U-matrix}
%\input{slides/tree}
%\input{slides/covertree}

%\input{slides/metricspace-short}
%\input{slides/intrinsic}

%\input{slides/knuth}
%\input{slides/experiments-synthetic}
%\input{slides/experiments-image}
%
...
%\input{slides/sgd-lemma}
%\input{slides/ass1}
%\input{slides/sgd-picture}
%\input{slides/vtree}
