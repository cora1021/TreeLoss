...
\uncover<1>{
\node (image) at (0,0.25) {\includegraphics[height=2.25in]{img/Lakeland_Terrier}};
...
\uncover<5>{
\node (image) at (0,0.25) {\includegraphics[height=2.25in]{img/Lakeland_Terrier}};
\node at (0,-4) {\Large more classes $\Rightarrow$ harder problem};
    %\node at (0,-5) {\Large generalization error = $O(\sqrt{k/n})$};
}

\uncover<5>{
\node (image) at (0,0) {\includegraphics[height=2.5in]{img/Lakeland_Terrier}};
\node[maybe] at (1.6875,-4) {Car};
\node[maybe] at (5,-4) {Tree};
\node[maybe] at (1.6875,-5) {House};
\node[maybe] at (5,-5) {Hat};
...
\uncover<8>{
\node (image) at (0,0) {\includegraphics[height=2.5in]{img/Airedale}};
\node[maybe] at (-5,-4) {Irish Terrier};
...
\uncover<9>{
\node (image) at (0,0) {\includegraphics[height=2.5in]{img/Irish-Terrier}};
...
\uncover<10>{
\node (image) at (0,0) {\includegraphics[height=2.5in]{img/water_spaniel}};
\node[maybe] at (-5,-4) {Irish Terrier};
\node[maybe] at (-1.6875,-4) {Airedale};
\node[maybe] at (1.6875,-4) {Horse};
\node[maybe] at (5,-4) {Human};
